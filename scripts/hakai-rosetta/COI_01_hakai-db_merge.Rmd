...
hakailist <- read.csv(here('hakaidata','2021BLASTDatabase', 'supporting',
                           'All_Hakai_Marine_Samples_WithCOI.csv'))

#this is their 2020 taxon mapping file from BOLD and Genbank
#there are no column names in this file
bold_genbank_taxa <- read.delim(here('hakaidata','2020Database', 'CO1_database',
                           'taxa_map', 'CO1.BOLD_genbank_combined.taxa_map.txt'),
                           header = FALSE)
```
