...
#write full
write.csv(chordata2, here(rosetta, 'taxize', '20220716_chordata_taxonomy-full.csv'))
...
#write out not-found
write.csv(chordata_notfound, here(rosetta, 'problems', '20220716_chordata_not-found.csv'))
...
#write out worms issues
write.csv(chordata_nf_worms, here(rosetta, 'problems', '20220716_chordata_worms-tol-conflict.csv'))
```
