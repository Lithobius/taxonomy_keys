...
#write out not-found
write.csv(annelid_notfound, here(rosetta, 'problems', 'not_found',
                                 '20220718_annelid_not-found.csv'))
...
write.csv(annelid_nf_worms, here(rosetta, 'problems', 'tol_conflict',
                                 '20220718_annelid_worms-tol-conflict.csv'))
```
...
#write out not-found
write.csv(arthropod_notfound, here(rosetta, 'problems', 'not_found',
                                   '20220718_arthropod_not-found.csv'))
...
#write out worms issues
write.csv(arthropod_nf_worms, here(rosetta, 'problems', 'tol_conflict',
                                   '20220718_arthropod_worms-tol-conflict.csv'))
```
...
#write out not-found
write.csv(chordata_notfound, here(rosetta, 'problems', 'not_found',
                                  '20220718_chordata_not-found.csv'))
...
#write out worms issues
write.csv(chordata_nf_worms, here(rosetta, 'problems', 'tol_conflict',
                                  '20220718_chordata_worms-tol-conflict.csv'))
```
...
#write out not-found
write.csv(mollusca_notfound, here(rosetta, 'problems', 'not_found',
                                  '20220718_mollusca_not-found.csv'))
...
#write out worms issues
write.csv(mollusca_nf_worms, here(rosetta, 'problems','tol_conflict',
                                  '20220718_mollusca_worms-tol-conflict.csv'))
```
...
#write out not-found
write.csv(ech_platy_nem_notfound, here(rosetta, 'problems', 'not_found',
                                       '20220718_ech_platy_nem_not-found.csv'))
...
#write out worms issues
write.csv(ech_platy_nem_nf_worms, here(rosetta, 'problems','tol_conflict',
                                       '20220718_ech_platy_nem_worms-tol-conflict.csv'))
```
...
#write full
write.csv(small_phyla2, here(rosetta, 'taxize', '20220718_smallphyla_taxonomy-full.csv'))
...
#write out not-found
write.csv(small_phyla_notfound, here(rosetta, 'problems', 'not_found',
                                     '20220718_small_phyla_not-found.csv'))
...
#write out worms issues
write.csv(small_phyla_nf_worms, here(rosetta, 'problems','tol_conflict',
                                     '20220718_small_phyla_worms-tol-conflict.csv'))
```
...
```{r read-in-if-needed}
annelid <- read_csv(here(rosetta, 'taxize', '20220718_annelid_taxonomy-full.csv'))[-1]
arthropod <- read_csv(here(rosetta, 'taxize', '20220718_arthropod_taxonomy-full.csv'))[-1]
chordata = read_csv(here(rosetta, 'taxize', '20220718_chordata_taxonomy-full.csv'))[-1]
mollusc <- read_csv(here(rosetta, 'taxize', '20220718_mollusca_taxonomy-full.csv'))[-1]
ech_platy_nem <- read_csv(here(rosetta, 'taxize', '20220718_ech_platy_nem_taxonomy-full.csv'))[-1]
small_phyla = read_csv(here(rosetta, 'taxize', '20220718_small_phyla_taxonomy-full.csv'))[-1]
```
...
# merge files
rosetta <- annelid %>%
  bind_rows(arthropod, chordata, mollusc, 
            ech_platy_nem, small_phyla)

# fix up; move columns around to make sense
rosetta <- rosetta %>%
  select(!(kingdom)) %>%
  relocate(c('phylum', 'class', 'order', 'family', 'genus'), .before = 'worms_aphiaid') %>%
  relocate('valid_authority', .before = 'worms_sciname') %>%
  relocate('taxa_query', .before = 'status') 


# save
write_csv(rosetta, here('species_lists', 'hakai', '2022rosetta', 'current_draft', 
                              '20210719_coi_rosetta_draft.csv'))
```
